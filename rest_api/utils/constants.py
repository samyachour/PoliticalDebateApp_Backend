...
progress_point_batch_post_debate_key_error = "Missing debate key from one of the progress objects."
progress_point_batch_post_seen_points_key_error = "Missing seen points key from one of the progress objects."
progress_point_batch_post_data_format_error = "Must be in array format."
...
unverified_email_error = "Email is unverified."
